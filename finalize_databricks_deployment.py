...
JOB_TASK_GOLD_NAME = "task_gold_ghe"

NOTEBOOKS_DIR = "./notebooks"
NOTEBOOK_TO_RUN = "1.0_Initialize"
NOTEBOOK_BRONZE = "2.0_ETL_Bronze_Layer"
NOTEBOOK_SILVER = "3.0_ETL_Silver_Layer"
NOTEBOOK_GOLD = "4.0_ETL_Gold_Layer"
# ======================= #
# MAIN FONCTIONS          #
# ======================= #
...
def ensure_etl_workflow(client, cluster_id):
    ...
    gold_task = {
        "task_key": JOB_TASK_GOLD_NAME,
        "depends_on": [{"task_key": JOB_TASK_SILVER_NAME}],
        "notebook_task": {
            "notebook_path": f"{DATABRICKS_NOTEBOOK_FOLDER}/{NOTEBOOK_GOLD}"
        },
        "existing_cluster_id": cluster_id
    }
